...
export default function Course5Phase2TravelWizard({
  ...
  const renderContextIcon = (ctx: string) => {
    ...
    { num: 2, label: "Screen 2 – Functional Phrase Bank Concept" },
    { num: 3, label: "Screen 3 – Activity 1: Understand Service Dialogues" },
    { num: 4, label: "Screen 4 – Activity 2: Interactive Travel Scenarios" },
    { num: 5, label: "Screen 5 – Mini-Quiz: Travel Survival Check" },
    { num: 6, label: "Screen 6 – Homework & AI Travel Day Simulation" }
  ];
