...
export default function Course4Phase5ParagraphsWizard({
  ...
  const renderTopicIcon = (iconName: string) => {
    ...
    { num: 2, label: "Activity 1 – Paragraph & Story Structure Concepts" },
    { num: 3, label: "Activity 2 – Reading Comprehension & Sentence Highlighting" },
    { num: 4, label: "Activity 3 – Custom Paragraph Planner & AI feedback" },
