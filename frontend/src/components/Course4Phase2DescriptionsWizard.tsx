    ...
    <div className="flex-grow flex flex-col justify-between max-w-2xl mx-auto w-full font-sans">
      ...
      {step === 1 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center text-center">
          ...
          <h2 className="text-4xl font-black text-white">Korean 3.2</h2>
          <h3 className="text-xl font-bold text-brand-400 mt-1">Describing People & Places</h3>
          ...
          {showOutline && (
            <div className="bg-zinc-950 p-4 rounded-xl border border-white/5 text-left text-xs text-zinc-400 space-y-1.5 animate-fade-in max-w-md mx-auto w-full font-mono">
              ...
              <p>✓ Activity 1 – Filterable adjective inventories & B1 templates</p>
              <p>✓ Activity 2 – Reading/listening descriptive comprehension</p>
              <p>✓ Activity 3 – Custom Person & Place builders with speech validation</p>
      ...
      {step === 6 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center text-center">
          ...
          <h2 className="text-3xl font-black text-white">Course 4 Phase 2 Completed!</h2>
