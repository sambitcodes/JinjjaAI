    ...
    <div className="flex-grow flex flex-col justify-between max-w-2xl mx-auto w-full">
      ...
      {step === 1 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center text-center">
          ...
          <h2 className="text-4xl font-black text-white">Korean 1.1</h2>
          <h3 className="text-xl font-bold text-brand-400 mt-1">Greetings & Polite Basics</h3>
      ...
      {step === 2 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-white/5">
            ...
            <button onClick={() => setStep(3)} className="bg-brand-500 hover:bg-brand-600 text-white px-5 py-2.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer">Start Listening Drills <ChevronRight className="w-4 h-4" /></button>
          </div>
        </div>
      )}
