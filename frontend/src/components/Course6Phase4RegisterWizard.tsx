...
export default function Course6Phase4RegisterWizard({
  ...
  const handleFinishPractice = async () => {
    ...
    { num: 2, label: "Screen 2 – Register & Style Concept Explanation" },
    { num: 3, label: "Screen 3 – Activity 1: Recognition & Context Matching" },
    { num: 4, label: "Screen 4 – Activity 2: Rewrite Drills & Style-Switch Chat" },
    { num: 5, label: "Screen 5 – Mini-Quiz: Register awareness checkpoints" },
