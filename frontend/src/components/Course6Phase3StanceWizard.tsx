    ...
    <div className="flex-grow flex flex-col justify-between max-w-2xl mx-auto w-full font-sans">
      ...
      {step === 1 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center text-center">
          ...
          <h2 className="text-3xl font-black text-white font-sans">Korean 5.3</h2>
          <h3 className="text-xl font-bold text-brand-400 mt-1">Nuanced Opinions & Soft Power</h3>
          ...
          {showOutline && (
            <div className="bg-zinc-950 p-4 rounded-xl border border-white/5 text-left text-xs text-zinc-400 space-y-1.5 animate-fade-in max-w-md mx-auto w-full font-mono">
              ...
              <p>✓ Screen 2 – C1 Stance & Softening slider</p>
              <p>✓ Screen 3 – Activity 1: Recognize Nuanced Stance (Strength, Hedging, Dialogues)</p>
              <p>✓ Screen 4 – Activity 2: Production (Hedged rewrites, Agreement builders, Debate chat)</p>
              <p>✓ Screen 5 – Mini-Quiz: Stance level checkpoints</p>
