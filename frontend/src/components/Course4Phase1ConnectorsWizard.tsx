...
export default function Course4Phase1ConnectorsWizard({
  ...
  const handleLaunchB1Tutor = async () => {
    ...
    { num: 2, label: "Activity 1 – Core connectors cards & before/after sentence mergers" },
    { num: 3, label: "Activity 2 – Connector matching & relationship classifiers" },
    { num: 4, label: "Activity 3 – \"But, Because, So\" sentence expansions & voice practice" },
