    ...
    <div className="flex-grow flex flex-col justify-between max-w-2xl mx-auto w-full font-sans">
      ...
      {step === 1 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center text-center">
          ...
          <h2 className="text-3xl font-black text-white font-sans">Korean 4.4</h2>
          <h3 className="text-xl font-bold text-brand-400 mt-1">Politeness & Register in Real Life</h3>
          ...
          {showOutline && (
            <div className="bg-zinc-950 p-4 rounded-xl border border-white/5 text-left text-xs text-zinc-400 space-y-1.5 animate-fade-in max-w-md mx-auto w-full font-mono">
              ...
              <p>✓ Screen 2 – Register, Politeness & Softening Chunks</p>
              <p>✓ Screen 3 – Activity 1: Recognize Appropriate Register</p>
              <p>✓ Screen 4 – Activity 2: Adjust & Soften Disagreements</p>
              <p>✓ Screen 5 – Mini-Quiz: Polite Interaction Check</p>
              <p>✓ Screen 6 – Homework & AI Politeness Practices</p>
            </div>
          )}
        </div>
      )}
