    ...
    <div className="flex-grow flex flex-col justify-between max-w-2xl mx-auto w-full font-sans">
      ...
      {step === 1 && (
        <div className="glass-panel neon-border p-8 rounded-3xl shadow-2xl w-full space-y-6 flex-grow flex flex-col justify-center text-center">
          ...
          <h2 className="text-3xl font-black text-white font-sans">Korean 4.1</h2>
          <h3 className="text-xl font-bold text-brand-400 mt-1">Keeping the Conversation Going</h3>
          ...
          {showOutline && (
            <div className="bg-zinc-950 p-4 rounded-xl border border-white/5 text-left text-xs text-zinc-400 space-y-1.5 animate-fade-in max-w-md mx-auto w-full font-mono">
              ...
              <p>✓ Screen 2 – Conversation Moves & Fillers Concept</p>
              <p>✓ Screen 3 – Activity 1: Recognize Good Conversation Moves</p>
              <p>✓ Screen 4 – Activity 2: Controlled → Semi-Free Drill Room</p>
              <p>✓ Screen 5 – Mini-Quiz: Interactive Skills Check</p>
              <p>✓ Screen 6 – Homework & Final Evaluation</p>
            </div>
          )}
        </div>
      )}
